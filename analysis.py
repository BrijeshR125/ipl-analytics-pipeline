...
try:
    ...
    print("Error: matches.csv not found. Please check the file path.")
...
try:
    ...
    print(f"Error: Column {e} not found in deliveries data.")
except Exception as e:
    print(f"Error during deliveries analysis: {e}")